            ...
            <div class="card">
                ...
                {{-- <div mbsc-page class="demo-multiple-select">
                    <div style="height: 100%;">
                        <label>
                            Multi-select
                            <input mbsc-input id="demo-multiple-select-input" placeholder="Please select..."
                                data-dropdown="true" data-input-style="outline" data-label-style="stacked"
                                data-tags="true" />
                        </label>
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            @if ($profile_picture && file_exists(storage_path('app/public/' .
                            $profile_picture)))
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            file_exists(storage_path('app/public/' . $doctor->profile_picture)))
                                            <img class="rounded-circle"
                                                src="{{ asset('storage/' . $doctor->profile_picture) }}" width="50"
                                                height="50">
                                            @else
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="#" wire:click="SetDeatailingDoctor({{ $doctor->id }})"
