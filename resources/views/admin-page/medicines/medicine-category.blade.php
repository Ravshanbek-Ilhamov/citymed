    ...
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" id="description" wire:model.blur="description" required
                                rows="3"></textarea>
            ...
            <div
                ...
                <!-- Card Title -->
                <h5 class="card-title text-primary m-0">Medicine Categories</h5>
                    ...
                    <div class="col">
                        <div class="input-group">
                            ...
                            <input type="search" wire:model.live.debounce.500ms="search"
                                class="form-control border-start-1  ps-2" placeholder="Search categories by name..."
                                style="border-color: #ced4da;">
                        </div>
                    </div>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-button-action d-flex align-items-center gap-1">
                                    <button wire:click.prevent="SeteditForm({{ $medicineCategory->id }})" type="button"
                                        class="btn btn-sm btn-primary" title="Edit Task">
                                        <i class="fa fa-edit"></i>
                                    </button>

                                    <button wire:click="prepareDelete({{ $medicineCategory->id }})"
