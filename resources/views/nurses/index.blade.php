                ...
                @if ($createForm || $editingForm)
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select" wire:model.blur="service_id" id="service_id">
                    ...
                    @else
                        <div
                                ...
                                <div class="col">
                                    <div class="input-group">
                                        ...
                                        <input type="search" wire:model.live.debounce.500ms="search"
                                            ...
                                            placeholder="Search nurses by name, email..."
                                            style="border-color: #ced4da;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Add Button -->
                            <button wire:click="SetcreateForm" class="btn btn-primary d-flex align-items-center"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($nurse->profile_picture && file_exists(storage_path('app/public/' . $nurse->profile_picture)))
                                                    <img class="rounded-circle"
                                                        src="{{ asset('storage/' . $nurse->profile_picture) }}"
                                                        width="50" height="50">
                                                @else
                                            ...
                                            <td>
                                                ...
                                                <div class="d-flex flex-column">
                                                    <a href="#"
                                                        wire:click="SetDeatailingNurse({{ $nurse->id }})"
                                            ...
                                            <td>
                                                <div
                                                    ...
                                                    <button wire:click.prevent="SeteditForm({{ $nurse->id }})"
